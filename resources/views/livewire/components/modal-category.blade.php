<div>
    ...
    <button type="button" class="mt-1 px-3 py-2 bg-blue-600 text-white rounded-xl hover:bg-blue-700" wire:click="addNew">
    ...
    <!-- Add Category Modal -->
    <div class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-40 overflow-y-auto h-full w-full" x-show="$wire.id_kategori === 'add_new'" style="display: none;">
