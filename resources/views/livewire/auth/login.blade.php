<div class="bg-white shadow-2xl p-8 max-w-md mx-auto rounded-lg">
    ...
    <form wire:submit.prevent="login" class="space-y-4">
      <div>
        <label for="username" class="block text-gray-700 font-medium mb-2 text-sm">Username</label>
        <div class="relative">
          ...
          <input type="text" id="username" wire:model="username" class="w-full pl-10 pr-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm" placeholder="Enter your username">
        </div>
      ...
      <div class="flex items-center justify-between">
        <div class="flex items-center">
          <input type="checkbox" id="remember" wire:model="remember" class="h-3 w-3 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
